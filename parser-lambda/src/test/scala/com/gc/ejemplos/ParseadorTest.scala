...
class ParseadorTest extends FunSuite {
  ...
  test("logParser con todas las tags en la traza - parser 2 arg") {
    val logTrace =
      """esto es un log TAG1 que contiene varias etiquetas TAG2 y
        |una TAG3 una marca final ## de hasta donde quiero parsear""".stripMargin
  ...
  test("logParser con tags que no existen al principio de la listaen la traza -parsere 2 arg") {
    val logTrace =
      """esto es un log TAG1 que contiene varias etiquetas TAG2 y
        |una TAG3 una marca final ## de hasta donde quiero parsear""".stripMargin
  ...
  test("logParser con tags que no existen al final de la lista en la traza - parser 2 arg") {
    val logTrace =
      """esto es un log TAG1 que contiene varias etiquetas TAG2 y
        |una TAG3 una marca final ## de hasta donde quiero parsear""".stripMargin
  ...
  test("logParser con tags que no existen al principio y al final de la lista en la traza - parser 2 arg") {
    val logTrace =
      """esto es un log TAG1 que contiene varias etiquetas TAG2 y
        |una TAG3 una marca final ## de hasta donde quiero parsear""".stripMargin
  ...
  test("logParser con tags que no existen en cual quier posicion de la lista en la traza - parser 2 arg") {
    val logTrace =
      """esto es un log TAG1 que contiene varias etiquetas TAG2 y
        |una TAG3 una marca final ## de hasta donde quiero parsear""".stripMargin
  ...
  test("logParser sin tags en la traza - parser 2 arg") {
    val logTrace =
      """esto es un log que contiene varias etiquetas y una marca final ## de hasta donde quiero parsear"""
